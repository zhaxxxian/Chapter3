...
//        animatorSet.start();
        ...
        ObjectAnimator scalezAnimator = ObjectAnimator.ofFloat(target,"alpha",1,0.5f);
        scalezAnimator.setRepeatCount(ValueAnimator.INFINITE);
        scalezAnimator.setInterpolator(new LinearInterpolator());
        scalezAnimator.setDuration(1000);
        scalezAnimator.setRepeatMode(ValueAnimator.REVERSE);
//        animatorSet = new AnimatorSet();
//        animatorSet.playTogether(scalezAnimator);
//        animatorSet.start();
        // TODO ex2-3: 将上面创建的其他 ObjectAnimator 都添加到 AnimatorSet 中
        animatorSet = new AnimatorSet();
        animatorSet.playTogether(animator1,scaleXAnimator,scaleYAnimator,scalezAnimator);
        animatorSet.start();
    }
}
